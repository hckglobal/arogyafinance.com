...
@section('content')
    <h5 style="text-align:right;">{{strtoupper($borrower->application->sanction_date)}}</h5>
        ...
        <table  cellspacing="0" class="compact">
            <tbody>
                ...
                <tr>
                    ...
                    <td>: </td>
                    <td>{{strtoupper($borrower->first_name)}} {{strtoupper($borrower->middle_name)}} {{strtoupper($borrower->last_name)}}</td>
                 </tr>
                <tr>
                    <td valign="top">8.</td>
                    ...
                    <td valign="top">
                        ...
                        (v) Repayment Instruments (Cheques/ECS/ACH) <br>
                    </td>
                </tr>                             
            </tbody>
    </table> 
    ...
    <p>
        Please note that this letter is valid only for a period of 3 months from the date of this letter.
    </p><br>
    <p>
