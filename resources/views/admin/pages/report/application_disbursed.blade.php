      ...
      <div class="col-xs-12">
        ...
        <div class="box">
            ...
            <div class="box-header">
              <h3>Disbursed Application Report</h3>
              ...
              <div class="row m-t-10 m-b-10">
                  <form action="/admin/report/disbursed" method="get">
                      ...
                      <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                           <div class="form-group contact-search m-b-30">
                              <label>&nbsp;</label>
                              <a class="btn btn-block btn-primary" href="/admin/report/disbursed/export?start-date={{Request::get('start-date')}}&end-date={{Request::get('end-date')}}">
