        ...
        <div class="box">
            ...
            <div class="box-header">
              ...
              <div class="row m-t-10 m-b-10">
                  <form action="/admin/report/{{$status}}" method="get">
                      ...
                      <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                           <div class="form-group contact-search m-b-30">
                              <label>&nbsp;</label>
                              <a class="btn btn-block btn-primary" href="/admin/report/{{$status}}/export?start-date={{Request::get('start-date')}}&end-date={{Request::get('end-date')}}">
