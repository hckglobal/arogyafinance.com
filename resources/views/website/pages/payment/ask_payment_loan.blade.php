...
<div class="container">
    <div class="row">
        ...
        <div class="paddingtop-class invoice-class">
            ...
            <h3>Would you like to pay for Arogya Loan ?</h3>
            <div class="divider">
            ...
            <div class="col-xs-6 col-xs-offset-3 text-center thanku-style">
                ...
                @elseif($application->type=="card")
                <a href="/payment/thank-you/{{$application->id}}" class="btn btn-danger btn-outline pull-right">Pay Later</a>
                @else
                <a href="/eligibility/select-language" class="btn btn-danger btn-outline pull-right">Pay Later</a>
                @endif
