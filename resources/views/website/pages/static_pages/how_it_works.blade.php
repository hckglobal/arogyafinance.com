            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 loan-work-flow">
                        ...
                        <img src="/assets/images/down-arrow.png" alt="" class="img-responsive text-center">
                        <div class="apply-now text-center"><button class="btn-primary btn-lg"><a href="/apply/loan/personal-details">Apply now</a></button></div>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4 loan-work-flow">
                      <img src="/assets/images/medical-expenses.png" alt="" class="img-responsive text-center">
                        ...
                        <img src="/assets/images/down-arrow.png" alt="" class="img-responsive text-center">
                        <div class="apply-now text-center"><button class="btn-success btn-lg"><a href="/apply/card/personal-details">Apply now</a></button></div>  
                    </div>
                </div>
            </div>
